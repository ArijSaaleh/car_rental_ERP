...
export default function Vehicles() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (selectedVehicle) {
        await vehicleService.update(selectedVehicle.id as any, formData);
        toast({
  ...
  const stats = {
    ...
    registrationExpiring: vehicles.filter(v => {
      const status = getExpiryStatus(v.registration_expiry);
      return status && (status.status === 'expire' || status.status === 'expire_bientot');
    }).length,
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-8 space-y-6">
      ...
      {vehicles.some(v => {
        ...
        const registrationStatus = getExpiryStatus(v.registration_expiry);
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="fuel_type" className="text-sm font-semibold text-gray-700">
                      Type de carburant *
                    </Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="daily_rate" className="text-sm font-semibold text-gray-700">
                      Prix journalier (TND) *
                    </Label>
                    <Input
                      id="daily_rate"
              ...
              <div className="bg-gradient-to-r from-purple-50 to-violet-50 p-4 rounded-lg border border-purple-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="insurance_expiry" className="text-sm font-semibold text-gray-700">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="registration_expiry" className="text-sm font-semibold text-gray-700">
                      <div className="flex items-center gap-2">
