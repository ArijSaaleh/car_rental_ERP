...
export class UpdateVehicleDto {
  @ApiPropertyOptional({ example: 'TUNIS-12345' })
  @IsOptional()
  @IsString()
  licensePlate?: string;

  @ApiPropertyOptional({ example: 'VF1234567890ABCDE' })
  @IsOptional()
  @IsString()
  vin?: string;
  ...
  @ApiPropertyOptional({ enum: FuelType, example: FuelType.ESSENCE })
  @IsOptional()
  @IsEnum(FuelType)
  fuelType?: FuelType;

  @ApiPropertyOptional({ enum: TransmissionType, example: TransmissionType.MANUELLE })
  @IsOptional()
  @IsEnum(TransmissionType)
  transmission?: TransmissionType;
  ...
  @ApiPropertyOptional({ example: 'INS987654' })
  @IsOptional()
  @IsString()
